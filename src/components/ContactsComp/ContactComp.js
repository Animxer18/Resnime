        ...
        <div>
            ...
            <div className={`modal ${props.hidden && "scale-100"}`}>
                <div className={`modal-body ${props.hidden && "scale-100 delay-500"}`}>
                    ...
                    <h1 className='text-3xl font-semibold'>Afah iyah, coba tebak gwehj siapa ?</h1>
                    <p className='text-sm text-slate-500'>Nama panggilan gapapa si</p>
            ...
            <div className={`modal ${props.hiddenFailedAlert && "scale-100"}`}>
                <div className={`modal-body ${props.hiddenFailedAlert && "scale-100 "}`}>
                   ...
                   <button onClick={()=>props.setHiddenFailedAlert(false)} className="px-4 py-2 rounded-md bg-blue-500 text-white my-5">Yah coba lagi deh</button>
                </div>
            </div>
